package com.tbprogmob.instaclone;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.setMessage("O portão ficou aberto, tentando fugir...");
                pd.show();
                ...
                if (TextUtils.isEmpty(str_username) || TextUtils.isEmpty(str_fullname) ||
                    ...
                    Toast.makeText(RegisterActivity.this, "Não dá pra entrar em casa sem chave$!", Toast.LENGTH_SHORT).show();
    ...
    private void register(final String username , final String fullname , String email , String password) {
        if (usernameFlag == 0) {
            ...
            pd.dismiss();
            Toast.makeText(this, "Não gostei do nome, tente novamente...", Toast.LENGTH_SHORT).show();
        }
    }
